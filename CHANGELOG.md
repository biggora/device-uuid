...
- Added GitHub Pages demo assets and related documentation updates.

## [3.0.3] - 2026-05-16

### Fixed

- **CodeQL ReDoS Alerts** - Hardened device UUID parsing regular expressions from PR #27, closing 5 CodeQL regular expression denial-of-service alerts
